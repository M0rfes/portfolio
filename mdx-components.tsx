...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    video: ({ ...props }) => (
      <span className="block my-8">
        <video {...props} className="rounded-lg shadow-md w-full" controls />
      </span>
    ),
    ...
    thead: ({ ...props }) => <thead className="blog-thead" {...props} />,
    tbody: ({ ...props }) => <tbody className="blog-tbody" {...props} />,
    th: ({ ...props }) => <th className="blog-th" {...props} />,
    td: ({ ...props }) => <td className="blog-td" {...props} />,
    ...
    strong: ({ ...props }) => <strong className="blog-strong" {...props} />,
    ...components,
  };
}
